...
export const metadata: Metadata = {
  ...
  description:
    "Validate IPv4 and IPv6 text, normalize IPv6 notation, inspect IPv4-mapped addresses and zone identifiers, and classify common special-purpose ranges.",
  alternates: {
  ...
  openGraph: {
    title: "IP Address Inspector | Validate IPv4 & IPv6 | Yoryantra",
    description:
      "Validate IP address text, normalize IPv6, and inspect common special-purpose IPv4 and IPv6 ranges.",
