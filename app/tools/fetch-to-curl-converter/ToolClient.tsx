...
export default function ToolClient() {
 ...
 description="Convert common JavaScript fetch() calls into reviewable cURL commands with masked sensitive values and explicit conversion warnings."
 >
 ...
 Paste a self-contained fetch() example. The converter reads common
 literal URLs, options, headers, and bodies without executing the code.
 </p>
 </div>
