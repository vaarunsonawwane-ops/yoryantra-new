    ...
    >
      ...
      <div className="mt-8">
        ...
        <div className="yoryantra-output min-h-[140px] flex items-center text-sm break-words">
          {output || "Your generated API key will appear here..."}
        </div>
      </div>
      ...
      <section className="mt-12 border-t border-gray-200 pt-10 space-y-10">
        <div>
          ...
          <p className="mt-4 text-gray-600 leading-relaxed">
            ...
            testing environments, webhooks, and internal tools.
          </p>
        ...
        <div>
          ...
          <div className="mt-5 space-y-6">
            ...
            <div>
              ...
              <p className="mt-2 text-gray-600 leading-relaxed">
                A 32-character key is common for general development and
                testing. For stronger secrets, developers often use 64
                characters or more depending on system requirements.
              </p>
            </div>
