...
export default function ToolClient() {
 ...
 ? "The DNS check timed out after 12 seconds."
 : "Unable to complete the DNS check."
 );
 setOutput("");
 } finally {
 ...
 description="Compare DNS answers from selected public DNS-over-HTTPS resolvers and review record values and TTLs in your browser."
 >
...
function formatReport(
 ...
 lines.push(
 "Note: Different answers were returned. This can happen during cache updates, but geo-aware DNS, load balancing, and resolver policy can also produce different records."
 );
