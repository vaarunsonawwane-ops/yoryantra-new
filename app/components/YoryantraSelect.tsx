    ...
    <div ref={wrapperRef} className="relative">
      {label && (
		...
		<button
		  ...
		  className="relative w-full rounded-xl border border-gray-300 bg-white p-4 pr-10 text-left text-sm text-[var(--dark)] outline-none transition focus:ring-2 focus:ring-[var(--green)] focus:border-transparent"
		>
